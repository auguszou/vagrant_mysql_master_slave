...
nodes = [
  { :hostname => 'master', :ram => 512, :ip => '192.168.2.10', :roles => ['mysql', 'master'] },
  { :hostname => 'slave1', :ram => 512, :ip => '192.168.2.20' , :roles => ['mysql', 'slave'] },
  { :hostname => 'slave2', :ram => 512, :ip => '192.168.2.30' , :roles => ['mysql', 'slave'] },
]
